...
document.getElementById("randomChoiceButton").onclick = () => {
  const restaurantList = [{
    name: '鳥ごころ 渋谷本店',
    feature: '全席個室の居酒屋で、落ち着いた雰囲気の中でプライベートな時間を過ごせます。食べ飲み放題コースや誕生日・記念日のお祝いに華やかなデザートが用意されており、感染症対策も徹底しています。個室でサプライズも可能で、新鮮な肉寿司や焼き鳥を楽しめるお店です。', //web pageの要約
    recommend_reason: '鳥ごころ 渋谷本店は、全席個室で落ち着いた雰囲気が魅力の居酒屋です。プライベートな空間で、新鮮な肉寿司や焼き鳥を楽しめるだけでなく、誕生日や記念日のお祝いにぴったりな華やかなデザートも提供されます。静かに食事を楽しみたい方や、特別な日のサプライズを考えている方におすすめです。',
    ...
    name: 'ぬる燗佐藤 渋谷ヒカリエ',
    feature: '都会の中にある洗練された大人の空間でありながら、優しく温かな和の雰囲気が漂い、リラックスしてお食事を楽しめるお店です。幅広いシーンにおすすめのテーブル席やカウンター席があり、日本酒充実のメニューも魅力的。友人や知人との食事やデートに最適な空間です。' ,//web pageの要約
    recommend_reason: 'ぬる燗佐藤 渋谷ヒカリエは、都会の喧騒から離れた洗練された大人の空間で、リラックスしながら食事ができるお店です。和の雰囲気が漂う店内で、豊富な日本酒メニューを楽しめるのがポイントです。デートや友人とのおしゃれなディナーに最適な場所を探している方にぴったりです。',
    ...
    name: '個室居酒屋 千鳥渋谷店',
    feature: 'この店は、友人や知人との来店シーンが多く、にぎやかで落ち着いた雰囲気が特徴です。料理のコスパが良く、綺麗な店内も好評です。大人数の宴会にも対応し、柔軟なサービスが評価されています。感染症対策や禁煙・喫煙にも配慮があり、安心して利用できるお店です。' ,//web pageの要約
    recommend_reason: '個室居酒屋 千鳥渋谷店は、友人や知人との集まりに最適で、賑やかな中にも落ち着きを感じられる居酒屋です。コスパの良い料理と綺麗な店内が評判で、大人数の宴会にも対応可能です。柔軟なサービスと感染症対策がしっかりしているため、安心して利用できるお店を探している方におすすめです。',
    ...
    recommend_reason: '金の餃子酒場 渋谷道玄坂店は、リーズナブルな価格で美味しい揚げ餃子が楽しめるのが魅力です。店内は広々としており、大人数での宴会やお祝いごとにも対応可能なので、友達や同僚と一緒に気軽に訪れるのに最適です。また、英語メニューやWi-Fiが完備されているため、外国人の友人とも安心して訪れることができます。',
  ...
  
  {
    ...
    recommend_reason: '本格中華食堂 『悟空』 渋谷店は、衛生管理が徹底されており、感染症対策を気にする方に特におすすめです。また、貸切対応も可能なので、特別なイベントやプライベートな集まりにもぴったりです。さらに、飲み放題＆食べ放題コースがあるため、予算を気にせず心ゆくまで中華料理を楽しめる点もポイントです。',
  ...
  ,{	name: '中華バル池湖',
    ...
    recommend_reason: '中華バル池湖は、隠れ家的な雰囲気が特徴で、特に目でも楽しめるオープンキッチンが魅力的です。シェフが目の前で料理を作る様子を楽しみながら、外の景色を眺めることができるカウンター席は、デートや静かな時間を楽しみたい時に最適です。また、レビュー評価が高いため、確かな味とサービスが期待できるでしょう。',
    ...
    feature: 'オーナーのこだわりが詰まったおしゃれな店内で、シンガポールの風景を描いた絵画が飾られています。シンガポールならではの雰囲気を楽しめるお店で、2種類のコースが用意されています。Wi-Fiやバリアフリー設備も整っており、お子様連れやウェディングパーティーにも対応しています。お店限定のお得な情報もチェックしてみてください。' ,//web pageの要約
    recommend_reason: '...',
    ...
    star: 4.4,
    genre: 'アジア・エスニック料理',
    image_url: 'https://imgfp.hotp.jp/IMGH/18/95/P044191895/P044191895_480.jpg',
    budget: '夜3001～4000円 昼1001～1500円',
  },
  
  {
    name: 'バンコクナイト渋谷',
    feature: 'この店は、店内がおしゃれでネオンが可愛く、タイにいるような雰囲気です。料理は美味しく、居心地も良いと評判です。接客も丁寧で、質問にも親切に答えてくれるそうです。英語メニューもあり、Wi-Fiも完備されています。お子様連れ不可で、貸切は不可です。店内は全席禁煙で、換気設備も整っています。設備面ではバリアフリーではなく、駐車場もありません。', //web pageの要約
    recommend_reason: '...',
  ...
  ,{
    ...
    feature: 'この店は、非常に素晴らしいコストパフォーマンスと料理・味を提供しており、来店者の97%が満足しています。一人での来店が59%であり、にぎやかで落ち着いた雰囲気が特徴です。感染症対策もしっかりと行われており、全席禁煙で35席の席数を持ち、最大宴会収容人数は30人です。Wi-Fiやバリアフリー設備はないが、貸切も可能です。15周年を迎え、コロナ感染対策も実施中です。' ,//web pageの要約
    recommend_reason: '...',
    ...
    feature: 'ディズニーモチーフのアイテムがたくさん揃う落ち着いた雰囲気の店内で、見た目も味もこだわったキャラクターモチーフのメニューを楽しめる。120席の広い席数とWi-Fi完備、バリアフリー設備も整っており、お子様連れも歓迎。アルコールメニューは提供されていないが、英語メニューもあり、ウェディングパーティーや二次会にも対応可能。', //web pageの要約
    recommend_reason: '...',
    ...
    feature: 'このお店は、料理や雰囲気がとても素晴らしいと評判です。来店者の95%が料理に、94%が雰囲気に満足しています。友人や知人との来店が51%で、記念日やサプライズが30%を占めています。お店の特長は、にぎやかで落ち着いた雰囲気で、女性客が7割以上で、1組当たりの人数は最大6人までです。' ,//web pageの要約
    recommend_reason: '...',
    ...
    name: '椿サロン　渋谷',
    feature: 'この店は料理や味、雰囲気がとても素晴らしいと評判です。来店者の96%が料理に満足し、91%が雰囲気に満足しています。友人や知人との来店が多く、落ち着いた雰囲気でリラックスできるお店です。感染症対策もしっかりしており、全席禁煙で35席の座席数があります。Wi-Fiも完備されており、貸切も可能です。', //web pageの要約
    recommend_reason: '...',
  ...
  
  {
    ...
    budget: '夜2001円~3000円　昼1501~2000円',
  },
  
  {
    ...
    budget: '夜7001円~10000円　昼1501円~2000円',
  },{
    name: '結亭　渋谷明治通り店',
    feature: '...' ,//web pageの要約
    recommend_reason: '...',
